...
public interface Fieldable extends Serializable {
  ...
  /** 
   * 此域是否分词True if the value of the field should be tokenized as text prior to
  ...
  /** 此域是保存字符串数据还是二进制数据True if the value of the field is stored as binary */
  boolean  isBinary();
