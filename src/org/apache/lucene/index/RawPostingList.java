...
abstract class RawPostingList {
  ...
  /**此term的文本在charPool中的偏移量（以buffers为统计容量，而非buffer）:由此可以知道是哪个词*/
  int textStart;
  /**此term相关信息在intPool中的起始偏移量:在指向的位置有两个int，一个是docid+freq信息的偏移量，一个是prox信息的偏移量。*/
  int intStart;
  /**此term相关信息在bytePool中的起始偏移量*/
  int byteStart;
}
