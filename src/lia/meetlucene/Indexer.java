...
//  E:\\LuceneIndex bin/lia/meetlucene/data
    String indexDir = args[0];         //1：File f = new File("E:\\LuceneIndex");
    String dataDir = args[1];          //2: File f = new File("bin/lia/meetlucene/data");
