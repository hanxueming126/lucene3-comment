...
public class QueryParserTest extends TestCase {
    ...
    public void testPrefixQuery() throws Exception {
        QueryParser parser =
                new QueryParser(Version.LUCENE_30, "category",
                        new StandardAnalyzer(Version.LUCENE_30));
        parser.setLowercaseExpandedTerms(false);
        System.out.println(parser.parse("/Computers/technology*").toString(
                "category"));
    }

    public void testFuzzyQuery() throws Exception {
        QueryParser parser =
                new QueryParser(Version.LUCENE_30, "subject", analyzer);
    ...
    public void testFuzzyQuery1() throws Exception {
        QueryParser parser =
                new QueryParser(Version.LUCENE_30, "subject", analyzer);
        Query query = parser.parse("\"test kountry~\"");
        System.out.println("fuzzy: " + query);

        query = parser.parse("test kountry~0.7");
        System.out.println("fuzzy 2: " + query);
    }
    ...
    */
    ...
    public void testPhraseQuery() throws Exception {
        Query q =
                new QueryParser(Version.LUCENE_30, "field",
                        new StandardAnalyzer(Version.LUCENE_30))
                        .parse("\"This is Some Phrase*\"");
        assertEquals("analyzed", "\"? ? some phrase\"", q.toString("field"));

        q =
                new QueryParser(Version.LUCENE_30, "field", analyzer)
                        .parse("\"term\"");
    ...
    public void testSlop() throws Exception {
        ...
        assertEquals("sloppy, implicitly", "\"sloppy phrase\"~5",
                q.toString("field"));
    }
    ...
    public void testParseException() {
        try {
            new QueryParser(Version.LUCENE_30, "contents", analyzer)
                    .parse("^&#");
        }
        catch (ParseException expected) {
