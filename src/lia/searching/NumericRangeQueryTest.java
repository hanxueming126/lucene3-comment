...
public class NumericRangeQueryTest extends TestCase {
	public void testInclusive() throws Exception {
		/* 创建索引类：CreateTestIndex */
		System.setProperty("index.dir",
				"E:\\downloads\\Lucene\\LIAsourcecode\\lia2e\\index");
		...
		for (int i = 0; i < matches.totalHits; i++) {
			System.out.println("match " + i + ": "
					+ searcher.doc(matches.scoreDocs[i].doc).get("author"));
		}
